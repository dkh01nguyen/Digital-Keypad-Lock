...
\fancyhead[L]{
 \begin{tabular}{rl}
    ...
    \put(0,-8){\includegraphics[width=9mm, height=9mm]{picture/logobk.png}}
   \end{picture}&
	\begin{tabular}{l}
...
\fancyfoot[L]{\footnotesize \ttfamily {Báo cáo Đồ án Thiết kế Luận lý}}
