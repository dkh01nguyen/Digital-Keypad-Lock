...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.6\textwidth}
        ...
        \label{fig:lcd2}
    \end{subfigure}
    \caption{Hình ảnh thực tế (trái) và sơ đồ chân cắm (phải) của màn hình LED}
    \label{fig:lcdlcd}
\end{figure}
...
lập với số đường tín hiệu chỉ bằng một nửa số trạng thái. 

Các phím bấm không có nguồn điện riêng 
...
\begin{table}[H]
    ...
    \begin{tabular}{|>{\centering\arraybackslash}m{7cm}|>{\centering\arraybackslash}m{7cm}|}    
        ...
        Buzzer 3V & Đơn vị phát âm thanh báo động \\ \hline
        Nút bấm & Hỗ trợ nhập liệu, xác thực và mô phỏng tác nhân người dùng \\ \hline
    \end{tabular}
    \end{adjustbox}
...
tìm kiếm chuỗi hiệu quả, được dùng để tìm một mẫu trong một đoạn văn bản. Thuật toán này sử dụng bước tiền xử lý để xử lý các 
